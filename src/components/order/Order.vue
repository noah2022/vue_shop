  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <el-table-column prop="order_price" label="订单价格" width="85px">
        </el-table-column>
        <el-table-column prop="pay_status" label="是否付款" width="85px">
        ...
        <el-table-column prop="is_send" label="是否发货" width="85px">
        </el-table-column>
